    ...
    for dirpath, dirnames, filenames in os.walk(root_dir):
        if target_filename in filenames:
            ...
            try:
                ...
                # df['source_folder'] = folder_name  # Add as a new column
                dataframes.append((folder_name, df))
                # print(f"Loaded from: {folder_name}")
...
summary_df['is_lower'] = summary_df['with_lag'] < summary_df['lag_share']
print(summary_df)
